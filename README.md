# capy-api-php-client
### The library supporting implement the API CAPY become to easier:
### I. Puzzle verify:
**_Step 1_: Create new instance**

$puzzleClient = new PuzzleClient($apiKey, $timeout);

With parameters:
- $apiKey: An API key is a key used for verifying site ownership. It can be obtained from
...
$avatarClient = new AvatarClient($apiKey, $timeout);

With parameters:
- $apiKey: An API key is a key used for verifying site ownership
- $timeOut : Request to server CAPY is Timeout (seconds)
