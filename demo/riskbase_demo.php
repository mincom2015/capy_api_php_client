<?php
    ...
    require_once __DIR__ . '/../src/RiskBaseClient.php';
    ...
    if($_POST['formSubmit'] == "Submit")
    {
        ...
        $riskbase_key = "n2hCcSNof52juVjZ7jarRN3sJKk4aCf9";
...
<form action="riskbase_demo.php" method="post">
    <script src="https://staging.capy.me/riskbase/riskbases/n2hCcSNof52juVjZ7jarRN3sJKk4aCf9/js"></script>
